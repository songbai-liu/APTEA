...
public class APTEA extends Algorithm{
	int populationSize;
	int maxEvaluations;
	int evaluations;
	...
	public SolutionSet execute() throws JMException, ClassNotFoundException {
		...
		while(evaluations <= maxEvaluations){
			if(evaluations % (populationSize*1) == 0) {
				SolutionSet[] st = getTrainingSet();
	...
	public void reproduction() throws JMException, ClassNotFoundException {
		...
		for (int i = 0; i < (populationSize/2); i++) {
			...
			}else if(rd < 0.75) {//search in the K-dimensional subspace
