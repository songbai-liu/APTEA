package jmetal.metaheuristics.aptea.BaseAE;
...
*/ 
public class BPAutoEncode implements IbpBase{
	...
	*/
	public BPAutoEncode(int features,int feaAfterEncode,int layerNum,double r) {
