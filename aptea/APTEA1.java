...
public class APTEA1 extends Algorithm{
	int populationSize;
	int maxEvaluations;
	int evaluations;
	...
	public SolutionSet execute() throws JMException, ClassNotFoundException {
		...
		while(evaluations <= maxEvaluations){
			...
			reproduction();
			environmentalSelection_Clustering();	
		}
	...
	public void reproduction() throws JMException, ClassNotFoundException {
		...
		for (int i = 0; i < (populationSize/2); i++) {
			...
			if(rd < 0.25) {//rd < productivity[t][0]
	...
	public void environmentalSelection_Clustering() {
		// Create the solutionSet union of solutionSet and offSpring
		union = ((SolutionSet) population).union(offspringPopulation);
		population.clear();
		offspringPopulation.clear();
