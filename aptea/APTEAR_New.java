...
public class APTEAR_New extends Algorithm{
	...
	public APTEAR_New(Problem problem) {
		super(problem);
		numObj_ = problem.getNumberOfObjectives();
		numVar_ = problem.getNumberOfVariables();
	}

	public APTEAR_New(Problem problem, QualityIndicator indicator) {
		super(problem);
		numObj_ = problem.getNumberOfObjectives();
		numVar_ = problem.getNumberOfVariables();
	...
	public SolutionSet execute() throws JMException, ClassNotFoundException {
		...
		//printGD("LAPTEAR_"+numObj_+"Obj_"+ problem_.getName() + "_" + numVar_ + "D_IGD.txt",IGD);
